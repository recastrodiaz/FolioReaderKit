...
class FolioReaderFontsMenu: UIViewController, SMSegmentViewDelegate, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        visibleHeight = self.readerConfig.allowDayNight ? visibleHeight : visibleHeight - 55
        ...
        // Day night mode
        let dayNightHeight : CGFloat = self.readerConfig.allowDayNight ? 55 : 0
        let dayNight = SMSegmentView(frame: CGRect(x: 0, y: 0, width: view.frame.width, height: dayNightHeight),
